...
namespace DoAnKTPM.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(DoAnKTPMContext context)
        {
            _context = context;
        }
        ...
        {
            Account taikhoan = _context.Accounts.Where(tkhoan => tkhoan.Username == Username && tkhoan.Password == Password).FirstOrDefault();
            if (taikhoan != null)
            {
